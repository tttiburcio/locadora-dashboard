    ...
    for id_ord_serv, grp in has_os.groupby("IDOrdServ"):
        ...
        for _, prow in grp.iterrows():
            ...
            parcela = models.ManutencaoParcela(
                ...
                fornecedor=_str(prow.get("Fornecedor")),
                empresa_temp=_str(prow.get("Empresa")) or _str(prow.get("IDContrato")),
                sistema_temp=_str(prow.get("Sistema")),
                servico_temp=_str(prow.get(serv_col)),
                descricao_temp=_str(prow.get("Descricao")),
