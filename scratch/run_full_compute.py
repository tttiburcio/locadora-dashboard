...
# Import main but set up fake environment
from main import compute

df_active, *_ = compute(2026)
row = df_active[df_active['Placa'] == 'EVF8I83']
print("Dashboard results for EVF8I83:")
print(row[['Placa', 'CustoManutencao', 'CustoTotal']])

# Also sum all components contributing to EVF8I83's maintenance total manually to double check
from main import load_raw, _filter_year, _parse, _dedup_manut, engine, text

# Reproduce logic manually
