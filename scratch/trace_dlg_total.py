...
def test_dlg_vehicle():
    ...
    # Look at specific record in SQL BEFORE override
    sql_match = sql_os[sql_os['IDOrdServ'] == 'OS-2026-0201']
    print("\n--- SQL Record FOR OS-2026-0201 ---")
    print(sql_match[['IDOrdServ', 'TotalOS', 'DataExecução']])
    ...
    relevant = manut[manut['Placa'] == 'DLG0D92']
    print("\nDetailed entries for DLG0D92:")
    print(relevant[['IDOrdServ', 'TotalOS', 'DataExecução']])
    print("\nSUM total for DLG0D92:", relevant['TotalOS'].sum())
